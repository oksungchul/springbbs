-- ���̺� �����ϱ�
BEGIN EXECUTE IMMEDIATE 'DROP TABLE TB_Bbs_Board'; EXCEPTION WHEN OTHERS THEN NULL; END; 
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE TB_Bbs_Article'; EXCEPTION WHEN OTHERS THEN NULL; END; 
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE TB_Bbs_Comments'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
BEGIN EXECUTE IMMEDIATE 'DROP TABLE TB_Bbs_Attachfile'; EXCEPTION WHEN OTHERS THEN NULL; END; 
/
